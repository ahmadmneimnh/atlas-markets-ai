...
import {
  sma, ema, rsi, macd, bollinger, atr, adx, vwap, ichimoku,
  rangeStats, maCross, supportResistance, momentum, volumeRatio,
...
describe('risk measures', () => {
  ...
  it('returns undefined volume ratio when volume is absent', () => {
    expect(volumeRatio(candles(new Array(30).fill(100), new Array(30).fill(0)), 20)).toBeUndefined();
  });
